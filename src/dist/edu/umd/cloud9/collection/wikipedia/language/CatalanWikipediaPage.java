 ...
 */
public class CatalanWikipediaPage extends WikipediaPage {
  /**
  ...
  protected static final Pattern DISAMB_PATTERN = Pattern.compile("\\{\\{desambiguaci\u00F3\\}\\}", Pattern.CASE_INSENSITIVE);
