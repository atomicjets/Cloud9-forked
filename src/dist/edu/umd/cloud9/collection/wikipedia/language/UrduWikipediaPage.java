 ...
 */
public class UrduWikipediaPage extends GenericWikipediaPage {
  /**
   * Language dependent identifiers of disambiguation, redirection, and stub pages.
   */
  private static final String[] LOWER_CASED_REDIRECTS = {"#\u0631\u062C\u0648\u0639_\u0645\u06A9\u0631\u0631"};
  private static final String DISAMB_PATTERN = NO_DISAMBIGUATION_DEFINED;
  private static final String LANGUAGE_CODE = "ur";

  /**
   * Creates an empty <code>UrduWikipediaPage</code> object.
   */
  public UrduWikipediaPage() {
