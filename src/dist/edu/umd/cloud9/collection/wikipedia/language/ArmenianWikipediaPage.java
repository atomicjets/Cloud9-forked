 ...
 */
public class ArmenianWikipediaPage extends GenericWikipediaPage {
  /**
   * Language dependent identifiers of disambiguation, redirection, and stub pages.
   */
  private static final String[] LOWER_CASED_REDIRECTS = {"#վերահղում"};
  private static final String DISAMB_PATTERN = NO_DISAMBIGUATION_DEFINED;
  private static final String LANGUAGE_CODE = "hy";

  /**
   * Creates an empty <code>ArmenianWikipediaPage</code> object.
   */
  public ArmenianWikipediaPage() {
