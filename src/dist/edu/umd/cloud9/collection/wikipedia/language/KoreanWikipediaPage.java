...
/**
 * A Korean page from Wikipedia.
 * 
 * @author Gaurav Ragtah
 */
public class KoreanWikipediaPage extends WikipediaPage {
  /**
  ...
  protected static final Pattern DISAMB_PATTERN = Pattern.compile("\\{\\{\uB3D9\uC74C\uC774\uC758\uC5B4|disambig\\}\\}", Pattern.CASE_INSENSITIVE);
