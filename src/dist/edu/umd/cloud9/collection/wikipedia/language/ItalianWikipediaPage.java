 ...
 */
public class ItalianWikipediaPage extends WikipediaPage {
  /**
  ...
  protected static final Pattern DISAMB_PATTERN = Pattern.compile("\\{\\{disambigua\\}\\}", Pattern.CASE_INSENSITIVE);
