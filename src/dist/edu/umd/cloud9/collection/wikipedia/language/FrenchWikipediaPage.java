 ...
 */
public class FrenchWikipediaPage extends WikipediaPage {
  /**
  ...
  protected static final Pattern disambPattern = Pattern.compile("\\{\\{homonymie\\s*\\|?\\s*\\w*\\}\\}", Pattern.CASE_INSENSITIVE);
