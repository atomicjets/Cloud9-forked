 ...
 */
public class FarsiWikipediaPage extends GenericWikipediaPage {
  /**
   * Language dependent identifiers of disambiguation, redirection, and stub pages.
   */
  private static final String[] LOWER_CASED_REDIRECTS = {"#TBD"};
  private static final String DISAMB_PATTERN = "#TBD";
  private static final String LANGUAGE_CODE = "TBD";

  /**
   * Creates an empty <code>FarsiWikipediaPage</code> object.
   */
  public FarsiWikipediaPage() {
