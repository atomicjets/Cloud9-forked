 ...
 */
public class BelarusianWikipediaPage extends GenericWikipediaPage {
  /**
  ...
  private static final String LANGUAGE_CODE = "be";

  /**
   * Creates an empty <code>BelarusianWikipediaPage</code> object.
   */
  public BelarusianWikipediaPage() {
