...
/**
 * A Waray page from Wikipedia.
 *
 * @author Nemanja Spasojevic
 */
public class WarayWikipediaPage extends GenericWikipediaPage {
  /**
  ...
  private static final String LANGUAGE_CODE = "war";

  /**
   * Creates an empty <code>WarayWikipediaPage</code> object.
   */
  public WarayWikipediaPage() {
