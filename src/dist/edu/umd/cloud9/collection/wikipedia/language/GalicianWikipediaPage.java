...
/**
 * A Galician page from Wikipedia.
 *
 * @author Nemanja Spasojevic
 */
public class GalicianWikipediaPage extends GenericWikipediaPage {
  /**
  ...
  private static final String LANGUAGE_CODE = "gl";

  /**
   * Creates an empty <code>GalicianWikipediaPage</code> object.
   */
  public GalicianWikipediaPage() {
