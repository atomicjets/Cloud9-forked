...
/**
 * A Hungarian page from Wikipedia.
 *
 * @author Nemanja Spasojevic
 */
public class HungarianWikipediaPage extends GenericWikipediaPage {
  /**
   * Language dependent identifiers of disambiguation, redirection, and stub pages.
   */
  private static final String[] LOWER_CASED_REDIRECTS = {"#átirányítás"};
  private static final String DISAMB_PATTERN = NO_DISAMBIGUATION_DEFINED;
  private static final String LANGUAGE_CODE = "hu";

  /**
   * Creates an empty <code>FarsiWikipediaPage</code> object.
   */
  public HungarianWikipediaPage() {
