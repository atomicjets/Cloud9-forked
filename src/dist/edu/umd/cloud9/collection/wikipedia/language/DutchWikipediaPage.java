 ...
 */
public class DutchWikipediaPage extends GenericWikipediaPage {
  /**
   * Language dependent identifiers of disambiguation, redirection, and stub pages.
   */
  private static final String[] LOWER_CASED_REDIRECTS = {"#doorverwijzing"};
  private static final String DISAMB_PATTERN = "\\{\\{dp\\}\\}";
  private static final String LANGUAGE_CODE = "nl";

  /**
   * Creates an empty <code>DutchWikipediaPage</code> object.
   */
  public DutchWikipediaPage() {
