...
/**
 * A Dutch page from Wikipedia.
 * 
 * @author Gaurav Ragtah
 */
public class DutchWikipediaPage extends WikipediaPage {
  /**
  ...
  protected static final Pattern DISAMB_PATTERN = Pattern.compile("\\{\\{dp\\}\\}", Pattern.CASE_INSENSITIVE);
