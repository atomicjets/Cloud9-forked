 ...
 */
public class FinnishWikipediaPage extends WikipediaPage {
  /**
  ...
  protected static final Pattern DISAMB_PATTERN = Pattern.compile("\\{\\{t\u00E4smennyssivu\\}\\}", Pattern.CASE_INSENSITIVE);
