 ...
 */
public class SerboCroatianWikipediaPage extends GenericWikipediaPage {
  /**
   * Language dependent identifiers of disambiguation, redirection, and stub pages.
   */
  private static final String[] LOWER_CASED_REDIRECTS = {"#preusmjeri", "#preusmeri"};
  private static final String DISAMB_PATTERN = NO_DISAMBIGUATION_DEFINED;
  private static final String LANGUAGE_CODE = "sh";

  /**
   * Creates an empty <code>SerboCroatianWikipediaPage</code> object.
   */
  public SerboCroatianWikipediaPage() {
