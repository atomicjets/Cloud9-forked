 ...
 */
public class PolishWikipediaPage extends WikipediaPage {
  /**
  ...
  protected static final Pattern DISAMB_PATTERN = Pattern.compile("\\{\\{ujednoznacznienie\\}\\}", Pattern.CASE_INSENSITIVE);
