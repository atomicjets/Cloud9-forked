...
/**
 * A Greek page from Wikipedia.
 *
 * @author Nemanja Spasojevic
 */
public class GreekWikipediaPage extends GenericWikipediaPage {
  /**
   * Language dependent identifiers of disambiguation, redirection, and stub pages.
   */
  private static final String[] LOWER_CASED_REDIRECTS = {"#ανακατευθυνση"};
  private static final String DISAMB_PATTERN = NO_DISAMBIGUATION_DEFINED;
  private static final String LANGUAGE_CODE = "el";

  /**
   * Creates an empty <code>GreekWikipediaPage</code> object.
   */
  public GreekWikipediaPage() {
