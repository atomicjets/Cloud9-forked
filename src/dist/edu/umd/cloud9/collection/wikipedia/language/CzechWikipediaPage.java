 ...
 */
public class CzechWikipediaPage extends GenericWikipediaPage {
  /**
   * Language dependent identifiers of disambiguation, redirection, and stub pages.
   */
  private static final String[] LOWER_CASED_REDIRECTS = {"#přesměruj"};
  private static final String DISAMB_PATTERN = "\\{\\{rozcestn\u00EDk\\}\\}";
