 ...
 */
public class GeorgianWikipediaPage extends GenericWikipediaPage {
  /**
   * Language dependent identifiers of disambiguation, redirection, and stub pages.
   */
  private static final String[] LOWER_CASED_REDIRECTS = {"#გადამისამართება"};
  private static final String DISAMB_PATTERN = NO_DISAMBIGUATION_DEFINED;
  private static final String LANGUAGE_CODE = "ka";

  /**
   * Creates an empty <code>GeorgianWikipediaPage</code> object.
   */
  public GeorgianWikipediaPage() {
