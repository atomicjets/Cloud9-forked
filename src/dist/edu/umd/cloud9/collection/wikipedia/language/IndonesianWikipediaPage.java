...
/**
 * A Indonesian page from Wikipedia.
 * 
 * @author Gaurav Ragtah
 */
public class IndonesianWikipediaPage extends WikipediaPage {
  /**
  ...
  protected static final Pattern DISAMB_PATTERN = Pattern.compile("\\{\\{disambig.*?\\}\\}", Pattern.CASE_INSENSITIVE);
  private static final String LANGUAGE_CODE = "id";

  /**
   * Creates an empty <code>IndonesianWikipediaPage</code> object.
   */
  public IndonesianWikipediaPage() {
    super();
  }
