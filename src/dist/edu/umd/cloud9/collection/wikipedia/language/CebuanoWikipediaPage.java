...
/**
 * A Cebuano page from Wikipedia.
 *
 * @author Nemanja Spasojevic
 */
public class CebuanoWikipediaPage extends GenericWikipediaPage {
  /**
  ...
  private static final String LANGUAGE_CODE = "ceb";

  /**
   * Creates an empty <code>FarsiWikipediaPage</code> object.
   */
  public CebuanoWikipediaPage() {
